                                ...
                                <div class="card-body pb-1 mx-25">
                                    <div v-if="payments.data.length >0">
                                        <div class="row pb-0.5">
                                            <div class="col-10">
                                                <h2 class="card-title mb-0 pt-1">Payments</h2>
                                            </div>
                                            <div class="col-2">
                                                                                    ...
                                                                                    <div class="col-12 pl-2 pt-1">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <p class="tag">
                                                                                                <input type="checkbox"
                                                                                                       name="address"
                                                                                                       v-model="query.partially_paid"
                                                                                                       id="partially_paid"><label
                                                                                                class="pl-1"
                                                                                                for="partially_paid">Partially
                                                                                                Paid</label>
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-12 pl-2 pt-1">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <p class="tag">
                                                                                                <input type="checkbox"
                                                                                                       name="amount_sent"
                                                                                                       v-model="query.amount_sent"
                                                                                                       id="amount_sent"><label
                                                                                                class="pl-1"
                                                                                                for="amount_sent">Amount</label>
                                                                                            </p>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group py-0">
                                            <div>
                                                ...
                                                <span v-if="ballance"
                                                    class="float-right">${{
                                                        (ballance.used_credits > 0 ? ballance.used_credits : '0.00')
                                                    }}</span>
                                                <span v-else
                                        ...
                                        <div class="col-md-12 form-group py-0 my-0">
                                            <div>
                                                ...
                                                <span v-if="ballance"
                                                    class="float-right">${{
                                                        ((ballance.balance > 0 ? ballance.balance : 0)).toFixed(2)
                                                    }}</span>
                                                <span v-else
                                                      class="float-right">0</span>
                                            </div>
...
export default {
    name: "Show",
    props: ['customer', 'payments', 'params', 'ballance'],
